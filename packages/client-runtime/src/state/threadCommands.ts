...
import {
  ...
  type PruneThreadHistoryInput,
  type RespondToThreadApprovalInput,
  type RespondToThreadUserInputInput,
  type RevertThreadCheckpointInput,
  type SetThreadInteractionModeInput,
  type SetThreadRuntimeModeInput,
  type SetThreadSkillPacksInput,
  type PinThreadInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    setSkillPacks: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:set-skill-packs",
      execute: (input: SetThreadSkillPacksInput) => setThreadSkillPacks(input),
      scheduler,
      concurrency,
    }),
    ...
    pruneHistory: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:prune-history",
      execute: (input: PruneThreadHistoryInput) => pruneThreadHistory(input),
      scheduler,
      concurrency,
    }),
