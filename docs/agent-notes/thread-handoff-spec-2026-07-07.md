...
- 2026-07-08 follow-up: user-facing fork-to-workspace and regular new-thread workspace bootstrap now share one `ws.ts` workspace preparation helper so workspace defaults and root normalization cannot diverge again.
