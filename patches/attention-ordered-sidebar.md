...
Explicit Active ordering wins inside either group once the user reorders it. Until then, the latest
user message orders threads inside each group. Working and monitoring remain normally prominent and
