...
import { shouldAnimateSnapShotArrival } from "../../lib/snapShotAnimation";
...
const TIMELINE_AT_LOGICAL_END = () => true;
...
function ComposerCommandMenuLayer(props: { anchor: HTMLElement | null; children: ReactNode }) {
  ...
  return createPortal(
    <div
      className="pointer-events-auto fixed z-[70] flex flex-col"
...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  const {
    ...
    isTimelineAtLogicalEnd = TIMELINE_AT_LOGICAL_END,
  ...
  const localComposerFilesRef = useRef<ComposerFileAttachment[]>([]);
  const composerFilesRef = externalComposerFilesRef ?? localComposerFilesRef;
  useEffect(() => {
  ...
  const composerControls = noProviderAvailable ? (
    <Button
      ...
      size="sm"
      variant="ghost"
      disabled={!providerSetupInstanceId || !onOpenProviderSetup}
      onClick={() => {
        if (providerSetupInstanceId && onOpenProviderSetup) {
  ...
  const activityStackContent = hasBannerItems ? (
    threadSyncPhase ? (
      <ComposerActivityRow phase={threadSyncPhase} />
  ...
  const onComposerMentionDragLeaveCapture = (event: React.DragEvent<HTMLElement>) => {
    ...
    >
      ...
      <ComposerBanner.Dock>
        <ComposerBanner.Column>
          ...
          />
          {!activityStackItem && (threadSyncPhase || inlineTasksBadge) ? (
              ...
              >
                {activePendingApproval ? (
                  ...
                  <ComposerPendingUserInputPanel
                    ...
                    onSkip={onSkipActivePendingUserInput}
        ...
        {!isComposerApprovalState && !isInlineComposer ? (
          <ComposerStashBadge
        ...
        >
          ...
          <div
            ...
            className={cn(
              ...
              inlineEdit !== undefined ? "pt-2.5 sm:pt-3" : "pt-3.5 sm:pt-4",
                    ...
                    return (
                      ...
                      >
                        <button
                          ...
                          onClick={() => composerContextActions.expandVideo(file.id)}
                        >
                          {file.file && (
                            <>
                ...
                <div className="mb-3 flex flex-col gap-1">
                  {composerOtherFiles.map((file) => {
                    ...
                    return (
                      ...
                      >
                        <PierreEntryIcon pathValue={file.name} kind="file" theme={resolvedTheme} />
                        <button
                          type="button"
