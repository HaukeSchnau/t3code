...
import { ChevronDownIcon, ChevronLeftIcon, ListPlusIcon, SquareIcon } from "lucide-react";
...
export const ComposerPrimaryActions = memo(function ComposerPrimaryActions({
    ...
    return (
      <div className={cn("flex items-center justify-end", compact ? "gap-1.5" : "gap-2")}>
        <Button
          ...
          {...pointerFocusProps}
          disabled={isSendBusy || isPreparingWorktree || !hasSendableContent}
  ...
  return (
    <button
      ...
      {...pointerFocusProps}
      disabled={isSendBusy || isSendDisabled || !hasSendableContent}
      aria-label={
        isPreparingWorktree
          ? "Preparing workspace"
          : isSendBusy
