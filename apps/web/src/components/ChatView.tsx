...
function ChatViewContent(props: ChatViewProps) {
  ...
  const onSend = async (
    ...
    if (!activeThread || isSendBusy || threadDetailLoading || sendInFlightRef.current) {
      notifyDirectAnnotationAttached();
      return;
    }
    if (activeEnvironmentUnavailable && (activePendingProgress || showPlanFollowUpPrompt)) {
      notifyDirectAnnotationAttached();
      return;
    }
    ...
    beginLocalDispatch({ preparingWorktree: Boolean(baseRevisionForWorkspace) });
