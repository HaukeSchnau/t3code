...
const CHAT_MARKDOWN_COMPONENTS = {
  ...
  p: function MarkdownParagraph({ node, children, ...props }) {
    const { renderBlock, skills } = use(ChatMarkdownRendererContext);
  ...
  li: function MarkdownListItem({ node, children, ...props }) {
    const { renderBlock, skills, text } = use(ChatMarkdownRendererContext);
    ...
    return typeof listItemStart === "number"
      ? (renderBlock?.({ id: `list-item:${listItemStart}`, kind: "list-item" }, element) ?? element)
      : element;
  },
