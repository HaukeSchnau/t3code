/* oxlint-disable react/no-unstable-nested-components -- ReactMarkdown renderers intentionally close over the current message context. */
...
function ChatMarkdown({
  ...
  const effectiveEnvironmentId = environmentId ?? activeEnvironmentId;
  ...
  const threadServerConfig = useAtomValue(
    serverEnvironment.configValueAtom(threadRef?.environmentId ?? effectiveEnvironmentId),
  );
