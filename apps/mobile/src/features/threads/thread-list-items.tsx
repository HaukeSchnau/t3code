    ...
    <View
      className={
        localIntent.tone === "danger"
          ? "rounded-full bg-adaptive-rose-500-a12-a16 px-1.5 py-0.5"
          : "rounded-full bg-adaptive-zinc-500-a12-a16 px-1.5 py-0.5"
      }
    >
      <Text
        className={
          localIntent.tone === "danger"
            ? "text-3xs font-t3-bold text-adaptive-red-700-300"
            : "text-3xs font-t3-bold text-adaptive-zinc-600-300"
        }
      >
        {localIntent.label}
      </Text>
