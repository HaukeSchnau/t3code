...
export function SettingsEnvironmentsRouteScreen() {
  ...
  const directEnvironments = connectedEnvironments.filter(
  ...
  const handleUpdateEnvironment = useCallback(
    (
      ...
      const actualEnvironment = directEnvironments.find(
    ...
    [directEnvironments, localEnvironments, onUpdateEnvironment],
  );
