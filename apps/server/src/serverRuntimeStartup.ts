    ...
    const startup = Effect.gen(function* () {
      ...
      yield* forkParked(
        Effect.gen(function* () {
          ...
          // Analytics may need to hydrate the projection before it can record the
          // heartbeat. Keep that best-effort work independent from the access
          // information printed immediately after activation.
