...
import Migration0033 from "./Migrations/033_ProjectionThreadQueuedMessages.ts";
import Migration0034 from "./Migrations/034_BackfillProjectionThreadLatestTurnId.ts";
import Migration0035 from "./Migrations/035_ProjectionThreadWorkspaces.ts";
import Migration0036 from "./Migrations/036_ProjectionProviderUsageLimits.ts";
import Migration0037 from "./Migrations/037_ProviderTranscriptJournal.ts";
...
import Migration0046 from "./Migrations/035_ProjectionThreadTitleRegeneration.ts";
import Migration0047 from "./Migrations/036_ProjectionThreadsPinned.ts";
import Migration0048 from "./Migrations/037_ProjectionTurnsKeysetIndex.ts";
import Migration0049 from "./Migrations/038_ProjectionThreadsPinOrderKey.ts";
import Migration0050 from "./Migrations/039_ProjectionProjectsDefaultThreadEnvMode.ts";
import Migration0051 from "./Migrations/040_ProjectionProjectFaviconPath.ts";
import Migration0052 from "./Migrations/052_ProjectionThreadTitleMode.ts";
import Migration0053 from "./Migrations/053_ProjectionProviderUsageHistory.ts";
import Migration0054 from "./Migrations/041_AuthSessionClientConnection.ts";
...
import Migration0059 from "./Migrations/059_ProjectionThreadActivityKindIndex.ts";
import Migration0060 from "./Migrations/060_ProjectionThreadRecentActivityIndex.ts";
import Migration0061 from "./Migrations/061_UpgradeCodexProjectDefaults.ts";
import Migration0062 from "./Migrations/062_ClearAutomaticProjectModelDefaults.ts";
import Migration0063 from "./Migrations/045_ProjectionProjectsAutoPull.ts";
import Migration0064 from "./Migrations/046_RepairAutomaticSettlementTimestamps.ts";
...
import Migration0069 from "./Migrations/048_ProjectionThreadBranchPullRequest.ts";
import Migration0070 from "./Migrations/049_ProjectionThreadsActiveOrderKey.ts";
import Migration0071 from "./Migrations/050_ProjectionThreadPullRequests.ts";
import Migration0072 from "./Migrations/051_ProjectionThreadMessageContext.ts";
...
export const migrationEntries = [
  ...
  [33, "ProjectionThreadQueuedMessages", Migration0033],
  [34, "BackfillProjectionThreadLatestTurnId", Migration0034],
  [35, "ProjectionThreadWorkspaces", Migration0035],
  [36, "ProjectionProviderUsageLimits", Migration0036],
  [37, "ProviderTranscriptJournal", Migration0037],
  ...
  [47, "ProjectionThreadsPinned", Migration0047],
  [48, "ProjectionTurnsKeysetIndex", Migration0048],
  [49, "ProjectionThreadsPinOrderKey", Migration0049],
  [50, "ProjectionProjectsDefaultThreadEnvMode", Migration0050],
  [51, "ProjectionProjectFaviconPath", Migration0051],
  [52, "ProjectionThreadTitleMode", Migration0052],
  [53, "ProjectionProviderUsageHistory", Migration0053],
  [54, "AuthSessionClientConnection", Migration0054],
  ...
  [59, "ProjectionThreadActivityKindIndex", Migration0059],
  [60, "ProjectionThreadRecentActivityIndex", Migration0060],
  [61, "UpgradeCodexProjectDefaults", Migration0061],
  ...
  [69, "ProjectionThreadBranchPullRequest", Migration0069],
  [70, "ProjectionThreadsActiveOrderKey", Migration0070],
  [71, "ProjectionThreadPullRequests", Migration0071],
  [72, "ProjectionThreadMessageContext", Migration0072],
