...
import Migration0029 from "./Migrations/029_JjTurnChangeMetadata.ts";
import Migration0030 from "./Migrations/030_ProviderSessionRuntimeInstanceIdCompatibility.ts";
...
export const migrationEntries = [
  ...
  [29, "JjTurnChangeMetadata", Migration0029],
  [30, "ProviderSessionRuntimeInstanceIdCompatibility", Migration0030],
] as const;
