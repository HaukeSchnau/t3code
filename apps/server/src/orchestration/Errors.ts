...
/** Raised when durable command preprocessing finds a receipt with a mismatched payload. */
export class OrchestrationCommandReceiptMismatchError extends Schema.TaggedError<OrchestrationCommandReceiptMismatchError>()(
