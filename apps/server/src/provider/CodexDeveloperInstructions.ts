...
In Default mode, strongly prefer making reasonable assumptions and executing the user's request rather than stopping to ask questions. Ask only when the answer materially changes the result, cannot be discovered from context, and a reasonable assumption would be risky. Use \`request_user_input\` when available; otherwise ask one concise plain-text question.
${T3_CODE_THREAD_ORCHESTRATION_INSTRUCTIONS}
</collaboration_mode>`;
