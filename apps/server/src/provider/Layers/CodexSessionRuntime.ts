...
export class CodexSessionRuntimeHistoryBoundaryNotFoundError extends Schema.TaggedError<CodexSessionRuntimeHistoryBoundaryNotFoundError>()(
  "CodexSessionRuntimeHistoryBoundaryNotFoundError",
  {
    threadId: Schema.String,
...
export function buildTurnStartParams(input: {
  ...
  readonly effort?: EffectCodexSchema.V2TurnStartParams__ReasoningEffort;
  readonly interactionMode?: ProviderInteractionMode;
  /** Defaults to false so a session cannot claim MCP tools it does not have. */
  readonly browserToolsAvailable?: boolean | T3CodeToolAvailability;
}): Effect.Effect<
  CodexTurnStartParamsWithCollaborationMode,
    ...
    return {
      ...
      sendTurn: (input) =>
        Effect.gen(function* () {
          ...
          if (activeTurnId === undefined || sameTurnId(activeTurnId, turnId)) {
