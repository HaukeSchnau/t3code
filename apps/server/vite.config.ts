...
export default {
  ...
  pack: {
    ...
    clean: true,
    deps: {
      // Both halves are required. `alwaysBundle` forces JavaScript dependencies
      // in, while `neverBundle` keeps native packages and their loaders on the
      // real filesystem so their prebuild resolution remains intact.
